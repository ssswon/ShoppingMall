...
$(document).ready(function() {
    ...
    $("#userid").on("keyup",function(){
    	$.ajax({
    		url:'idDulicateCheck', //서버 주소
    		type:"get",
    		data:{
    			id:$("#userid").val(), //전송 데이터 id
    		},
    		dataType:"text",//응답 데이터 타입
    		success:function(data,status,xhr){
    			console.log(data);	//아아디 중복, 아이디 사용가능
    			$("#result").html(data);	//중복 여부 화면에 출력
    		},
...
<form action="memberAdd" method="get">
	*아이디:<input type="text" name="userid" id="userid"> <span
		...
		id="passwd"><br> 비빌번호확인:<input type="text" name="passwd2"
