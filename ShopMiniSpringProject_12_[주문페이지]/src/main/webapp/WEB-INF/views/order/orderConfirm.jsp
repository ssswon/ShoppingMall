...
<form name="myForm" method="get" action="loginCheck/CartOrderDone">
...
<input type="hidden" name="num" value="${cdto.num }"><!-- cart번호 -->
				...
				<tr>
					...
					<td height="35" class="td_default">
						<input class="input_default" type="text" id="mphone" size="15"
							maxlength="15" value="${mdto.phone1+mdto.phone2+mdto.phone2 }"></input>
