...
public class GoodsController {
	...
	public String delAllCart(@RequestParam(value= "check") List<Integer> num) {//check인 애들을 list에 담아 가져오기
		System.out.println("GoodsController : delAllCart() 넘어온 List<> num = "+num);
